      ...
      const htmlContent = `
        ...
        <html>
          ...
          <body style="font-family: Helvetica; padding: 20px;">
            ...
            ${signature ? `<img src="${signature}" style="width: 200px; border: 1px solid #ccc;" />` : ''}
  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <KeyboardAvoidingView
        ...
        behavior={Platform.OS === 'ios' ? 'padding' : 'height'} // Mudei para 'height' no Android
      ...
      >
        ...
        <ScrollView
          ...
          style={{ flex: 1 }} // IMPORTANTE: Garante que o Scroll ocupe tudo
          ...
          persistentScrollbar={true}          // Força a barra a ficar visível (Android)

          indicatorStyle={isDarkMode ? 'white' : 'black'} // Contraste da barra (iOS)
