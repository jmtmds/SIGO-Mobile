...
const FormInput = ({ label, value, onChangeText, placeholder, multiline = false, theme, highContrast, dynamicText }) => (
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  scrollContent: { padding: 24, paddingBottom: 100 }, // Mais espaço embaixo
